...
For example you can simulate a stoachasitc volatility with one factor and jump (SV1FJ) model for 1200 days using the following code.
...
Then we can obtain the p-value matrix for the three methods. We can do further p-values pooling and FDR control via BH [@benjamini1995controlling] procedure. We provided six pooling methods, four for independent [@won2009choosing, @chang2013meta] and two for dependent [@chang2013meta] strucure. We suggested Stouffer's dependent (SD) structure.
